...
def test_list_default(mock_config, capsys, populate_db, debug) -> None:
...
def test_list_short(mock_config, capsys, populate_db, debug) -> None:
...
def test_list_default_full(mock_config, capsys, populate_db, debug) -> None:
...
def test_list_hidden_commands(mock_config, capsys, populate_db, debug) -> None:
...
def test_list_no_commands(mock_config, capsys, debug) -> None:
...
def test_list_category_not_found(mock_config, capsys, populate_db, debug) -> None:
...
def test_list_single_category(mock_config, capsys, populate_db, debug) -> None:
...
def test_list_single_category_short(mock_config, capsys, populate_db, debug) -> None:
...
def test_list_multiple_category(mock_config, capsys, populate_db, debug) -> None:
...
def test_list_categories(mock_config, capsys, populate_db, debug) -> None:
